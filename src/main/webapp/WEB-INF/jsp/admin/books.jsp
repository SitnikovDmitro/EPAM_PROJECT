...
<html lang="en">
    ...
    <body class="d-flex flex-column min-vh-100" style="background-image: url('${pageContext.request.contextPath}/static/img/background.jpg'); background-repeat: no-repeat; background-attachment: fixed;">
        <pf:adminBookDetailsModal/>
        <pf:adminCreateBookModal/>
        <f:selectPublisherModal/>



        <pf:adminNavbar activePage="books"/>
        ...
        <div class="container-fluid col-lg-8 col-md-12">
            <div class="card mt-4">
                <div class="card-header">
                  <ul class="nav nav-tabs card-header-tabs" role="tablist">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" data-bs-toggle="tab" href="#newTabPanel" role="tab"><t:localize key="new"/></a>
                    </li>
                  </ul>
                </div>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="newTabPanel" role="tabpanel">
                        <div class="card-body">
                            <button type="button" class="btn btn-primary btn-block" data-bs-toggle="modal" data-bs-target="#createBookModal"><t:localize key="createBook"/></button>
                        </div>
                    </div>
                    ...
                    <div class="${(advancedSearch == true)?'tab-pane fade':'tab-pane fade show active'}" id="basicSearchTabPanel" role="tabpanel">
                        <div class="card-body">
                            <form action="${pageContext.request.contextPath}/admin/books/find/basic" method="post" id="basicSearchBooksForm">
                                <div class="row">
                    ...
                    <div class="${(advancedSearch == true)?'tab-pane fade show active':'tab-pane fade'}" id="advancedSearchTabPanel" role="tabpanel">
                        <div class="card-body">
                            <form action="${pageContext.request.contextPath}/admin/books/find/advanced" method="post" id="advancedSearchBooksForm">
                                <div class="row">
            ...
            <f:pagination url="${pageContext.request.contextPath}/admin/books/show"/>
        </div>

        <f:footer/>

        <script>
            $('#selectPublisherModal').on('hidden.bs.modal', function () {
