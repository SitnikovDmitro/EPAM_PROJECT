...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <ul class="navbar-nav mr-auto">
        <c:choose>
            ...
            <c:otherwise>
                <li class="nav-item">
                    <a class="nav-link" href="${pageContext.request.contextPath}/librarian/orders/show"><t:localize key="orders"/></a>
                </li>
            </c:otherwise>
        </c:choose>
        ...
        <c:choose>
            ...
            <c:otherwise>
                <li class="nav-item">
                    <a class="nav-link" href="${pageContext.request.contextPath}/librarian/books/show"><t:localize key="books"/></a>
                </li>
            </c:otherwise>
        </c:choose>
        ...
        <c:choose>
            ...
            <c:otherwise>
                <li class="nav-item">
                    <a class="nav-link" href="${pageContext.request.contextPath}/librarian/readers/show"><t:localize key="readers"/></a>
                </li>
            </c:otherwise>
        </c:choose>
    </ul>

    <span class="navbar-text mr-4"><t:localize key="hello"/>, <span class="fst-italic">${librarianFullname}</span></span>
