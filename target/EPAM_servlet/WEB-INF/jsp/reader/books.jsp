...
<html lang="en">
    ...
    <body class="d-flex flex-column min-vh-100" style="background-image: url('${pageContext.request.contextPath}/static/img/background.jpg'); background-repeat: no-repeat; background-attachment: fixed;">
        ...
        <pf:readerBookDetailsModal/>
        <pf:readerCreateFeedbackModal/>
        <pf:readerPayFineModal/>



        <pf:readerNavbar activePage="books"/>
        ...
        <div class="container-fluid col-lg-8 col-md-12">
            <div class="card mt-4">
                ...
                <div class="tab-content">
                    ...
                    <div class="${(advancedSearch == true)?'tab-pane fade':'tab-pane fade show active'}" id="basicSearchTabPanel" role="tabpanel">
                        <div class="card-body">
                            <form action="${pageContext.request.contextPath}/reader/books/find/basic" method="post" id="basicSearchBooksForm">
                                <input type="hidden" name="bookmarksOnly" value="${(bookmarksOnly == true)?'true':'false'}" id="basicSearchBookmarksOnlyInput">
                                ...
                                <div class="row mt-2">
                                    <div class="col-6 pr-1">
                                        <button type="button" class="${(bookmarksOnly == true)?'btn btn-block btn-primary':'btn btn-block btn-primary active'}" onclick="switchToAll();"><t:localize key="all"/></button>
                                    </div>

                                    <div class="col-6 pl-1">
                                        <button type="button" class="${(bookmarksOnly == true)?'btn btn-block btn-primary active':'btn btn-block btn-primary'}" onclick="switchToBookmarks();"><t:localize key="bookmarks"/></button>
                                    </div>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="${(advancedSearch == true)?'tab-pane fade show active':'tab-pane fade'}" id="advancedSearchTabPanel" role="tabpanel">
                        <div class="card-body">
                            <form action="${pageContext.request.contextPath}/reader/books/find/advanced" method="post" id="advancedSearchBooksForm">
                                <input type="hidden" name="bookmarksOnly" value="${(bookmarksOnly == true)?'true':'false'}" id="advancedSearchBookmarksOnlyInput">
                                ...
                                <div class="row">
                                    <div class="col-3 pr-1">
                                        <div class="input-group">
                                            ...
                                            <select class="custom-select" name="format" id="formatSelect">
                                    ...
                                    <div class="col-3 px-1">
                                        <div class="input-group">
                                            ...
                                            <select class="custom-select" name="genre" id="genreSelect">
                                    ...
                                    <div class="col-3 pl-1">
                                        <div class="input-group">
                                            ...
                                            <select class="custom-select" name="sortCriteria" id="sortCriteriaSelect">
                                ...
                                <div class="row mt-2">
                                    <div class="col pr-1">
                                        <input type="text" class="form-control" name="titleQuery" value="${titleQuery}" id="titleQueryInput" placeholder="<t:localize key='titleQuery'/>" maxlength="50">
                                    </div>

                                    <div class="col pl-1">
                                        <input type="text" class="form-control" name="authorQuery" value="${authorQuery}" id="authorQueryInput" placeholder="<t:localize key='authorQuery'/>" maxlength="50">
                                    </div>
                                </div>
                                ...
                                <div class="row mt-2">
                                    <div class="col-3 pr-1">
                                        <input type="number" class="form-control" name="isbn" value="${isbn}" id="isbnInput" placeholder="<t:localize key='isbn'/>" maxlength="4" min="0" step="1" max="9999">
                                    </div>
            ...
            <f:pagination url="${pageContext.request.contextPath}/reader/books/show"/>
        </div>

        <f:footer/>

        <script>
            $('#createFeedbackModal').on('hidden.bs.modal', function () {
